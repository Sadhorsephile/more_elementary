...
abstract class IElementaryWidgetModelTest implements IWidgetModel {}

class TestWidgetModel extends WidgetModel<TestElementaryWidget, ElementaryModelMock>
    with SingleTickerProviderWidgetModelMixin<TestElementaryWidget, ElementaryModelMock>
...
class TestElementaryWidget extends ElementaryWidget<IElementaryWidgetModelTest> {
  const TestElementaryWidget(
    WidgetModelFactory<WidgetModel<ElementaryWidget<IWidgetModel>, ElementaryModel>> wmFactory, {
    Key? key,
  }) : super(
          wmFactory,
          key: key,
  ...
  @override
  Widget build(BuildContext context, IElementaryWidgetModelTest wm) {
    return MaterialApp(
      home: Scaffold(
        body: Container(),
      ),
...
class ElementaryModelMock extends Mock with MockElementaryModelMixin implements ElementaryModel {}
