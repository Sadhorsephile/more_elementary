...
void main() {
  ...
  group('In tree interaction.', () {
    ...
    test('OnErrorHandler should returns normally', () {
      expect(() => wm.onErrorHandle(1, null), returnsNormally);
    });
  });
...
class ElementaryWidgetTest extends ElementaryWidget<IWidgetModel> {
...
class ElementaryWidgetModelTest extends WidgetModel<ElementaryWidgetTest, ElementaryModelMock>
