...
void main() {
  ...
  late StackTrace? stackTraceHolder;
  void fakeWmHandler(Object error, StackTrace? s) {
  ...
  test('ErrorHandler should get every error from handleError', () {
    ...
    verify(() => errorHandler.handleError(error, stackTrace: stackTrace)).called(1);
    verify(() => errorHandler.handleError(error2, stackTrace: stackTrace2)).called(1);
  });
